...
foreach $file (sort @files)
{
	...
	print "python /data/jh7x3/GFOLD_v0.1/examples/GFOLD.py  --target $pdbname  --fasta $fasta_dir/$file --ss $ssfile  --hbond 1 --restraints $restraintsfile --type CB --distdev 1  --epoch 100  --cgstep 100  --dir  $outdir\n";
	#system("python /data/jh7x3/GFOLD_v0.1/examples/GFOLD.py  --target $pdbname  --fasta $fasta_dir/$file --ss $ssfile  --hbond 1 --restraints $restraintsfile --type CB --distdev 1 --epoch 100  --cgstep 100  --dir  $outdir");
