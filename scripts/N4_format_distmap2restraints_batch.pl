...
foreach $file (@files)
{
	...
	print "perl /data/jh7x3/GFOLD_v0.1/examples/scripts/N4_format_distmap2restraints.pl  $fasta_dir/$file  $distfile  $work_dir/$pdbname.restraints\n";
	`perl /data/jh7x3/GFOLD_v0.1/examples/scripts/N4_format_distmap2restraints.pl  $fasta_dir/$file  $distfile  $work_dir/$pdbname.restraints`;
}
