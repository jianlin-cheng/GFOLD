...
foreach $file (sort @files)
{
	...
	print "python /data/jh7x3/GFOLD_v0.1/examples/GFOLD.py  --target $pdbname  --fasta $fasta_dir/$file --ss $ssfile  --hbond 1 --restraints $restraintsfile --type CB --distdev 0.1  --epoch 10  --cgstep 100  --dir  $outdir --sep 1\n";
	system("python /data/jh7x3/GFOLD_v0.1/examples/GFOLD.py  --target $pdbname  --fasta $fasta_dir/$file --ss $ssfile  --hbond 1 --restraints $restraintsfile --type CB --distdev 0.1 --epoch 10  --cgstep 100  --dir  $outdir --sep 1");
