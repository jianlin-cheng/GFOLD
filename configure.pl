...
{
	die "The GFOLD databases/tools folder ($GFOLD_db_tools_dir) is not existing\n";
}
...
######### check the GFOLD database and tools
...
{
	die "Failed to find databases and tools under $GFOLD_db_tools_dir/\n";
}

if($GFOLD_db_tools_dir eq "$cur_dir/")
{
	die "Same directory as GFOLD main folder. Differnt path for original databases/tools folder $GFOLD_db_tools_dir is recommended.\n";
}
...
if (prompt_yn("GFOLD will be installed into <$install_dir> ")){
...
$option_list = "$install_dir/installation/GFOLD_configure_files/GFOLD_examples_list";

if (! -f $option_list)
{
        die "\nOption file $option_list not exists.\n";
}
system("rm $install_dir/installation/GFOLD_test_codes/*.sh");
configure_file2($option_list,'installation');
print "#########  Configuring examples, done\n\n\n";

system("chmod +x $install_dir/installation/GFOLD_test_codes/*sh");



system("cp $install_dir/src/run_GFOLD.sh $install_dir/bin/run_GFOLD.sh");
system("chmod +x $install_dir/bin/run_GFOLD.sh");



print "#########  (5) Configuring database update scripts\n";

$option_list = "$install_dir/installation/GFOLD_configure_files/GFOLD_db_list";
...
#installation/GFOLD_programs/.P1_run_hhsearch.sh

print "#########  (7) Configuring GFOLD programs\n";
$method_file = "$install_dir/method.list";
$option_list = "$install_dir/installation/GFOLD_configure_files/GFOLD_programs_list";

`rm $install_dir/installation/GFOLD_programs/*sh`;
...
if(!(-e $method_file) or !(-e $option_list))
{
	...
	@contents = <IN>;
	open(TMP,">$install_dir/installation/GFOLD_configure_files/option.tmp");
	...
	close TMP;
	configure_file2("$install_dir/installation/GFOLD_configure_files/option.tmp",'installation');
	`rm $install_dir/installation/GFOLD_configure_files/option.tmp`;
	`cp $install_dir/installation/GFOLD_programs/*sh $install_dir/bin/`;
...
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/chain_stx_info
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/pdb_cm
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/pdb_cm.phr
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/pdb_cm.pin
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/pdb_cm.psq
/home/casp13/GFOLD_package/software/prosys_database/cm_lib/pdb_cm_all_sel.fasta 


/home/casp13/GFOLD_package/software/prosys_database/atom.tar.gz

/home/casp13/GFOLD_package/software/prosys_database/nr_latest/
